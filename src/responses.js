...
const badRequest = (request, response, type, params) => {
  ...
  // if the parameters are invalid, change object.message to ask
  // for valid params and status code to 400
...
const unauthorized = (request, response, type, params) => {
  ...
  // if the parameters are invalid, change object.message to ask for valid
  // params and status code to 401
